...
$setAlign = $db->prepare("INSERT INTO entities_translations_align (pair,json,user_id,group_id,created_at,modified_at) VALUES (:pair,:json,:user,:group,NOW(), NOW()) ON DUPLICATE KEY UPDATE modified_at = NOW(), json = :json");
...
$setAlign->execute() or die('unable to set align');
?>
